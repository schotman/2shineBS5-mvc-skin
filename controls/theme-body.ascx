...
<div id="theme-page-header-pane" class="container-xxl px-0 <%= (HeaderPane.Attributes["class"] ?? "").Contains("DNNEmptyPane") ? "theme-header-pane-empty" : "" %>">
  <div id="HeaderPane" class="dnnPane"  runat="server" containertype="G" containername="2shineBS5" containersrc="fullwidthWithoutPadding.ascx"></div>
</div>

<main id="theme-page-main">
  <% if(ShowBreadcrumb) { %>
  <div class="ContentPane Pane Breadcrumb">
...
<footer id="theme-page-footer" class="footer">
  <div class="container py-4 d-flex justify-content-md-between flex-column flex-md-row text-white">
    <div class="theme-footer-address d-flex flex-column flex-xl-row">
      <dnn:COPYRIGHT id="DnnCopyright" cssclass="theme-page-login copyright" runat="server" />
    </div>
